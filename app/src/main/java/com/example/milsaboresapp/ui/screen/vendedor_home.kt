...
import com.example.milsaboresapp.presentation.vendedor.VendedorDashboardViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun VendedorHomeScreen(
    state: VendedorDashboardViewModel.UiState,
    onWidgetClick: (VendedorDestination) -> Unit,
    onBackToStore: () -> Unit,
    onLogout: () -> Unit
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = dashboard?.title ?: "Panel de Vendedor") },
                actions = {
...
@Composable
private fun VendedorWidgetCard(
    widget: VendedorWidget,
    onClick: () -> Unit
) {
    Card(
